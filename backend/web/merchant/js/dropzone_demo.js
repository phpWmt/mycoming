...
function createDropzone(id,paramName,maxFilesize,maxFiles,crsfValue,img_update=null){
    $("div#"+id).dropzone({
        params:{'_csrf-merchant':crsfValue,'paramName':paramName},
        ...
        init: function () {
            ...
            this.on("queuecomplete",function(file) {
                ...
                this.on("removedfile",function(file){
                    ...
                    $.ajax({
                        type: "post",
                        url: "/merchant/merchant-goods/delete-img",
                        data: {"url":url,"_csrf-merchant": $("meta[name='csrf-token']").attr("content")},
                        dataType: "json",
