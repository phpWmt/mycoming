                            ...
                            <?php if (is_array($lists)): foreach ($lists as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?php echo Url::to(['user/update', 'id' => $v['id']]) ?>">
                                            <button type="button" class="btn btn-success btn-xs btn-outline btn-rounded"><i class="fa fa-paste"></i>&nbsp;编辑</button>
                                        </a>

                                        <a href="  <?php echo Url::to(['user/show', 'id' => $v['id']]) ?>">
                                            <button type="button" class="btn btn-info btn-xs btn-outline btn-rounded"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;查看</button>
                                        </a>

                                        <button data-id="<?php echo $v['id']?>" data-delete="0" href="javascript:void (0)" type="button" class="btn btn-danger btn-outline btn-xs del btn-rounded"><i class="fa fa-trash-o"></i>&nbsp;删除</button>
      ...
      $.ajax({
        ...
        $(".del").click(function () {
            ...
            var d = dialog({
                title: '友情提示',
                id: 'del_pro',
                content: '您确定要删除此用户吗？当前删除用户将加入回收站！',
                ok: function () {
                    $.ajax({
                        url: "/user/delete",
                        type: "post",
