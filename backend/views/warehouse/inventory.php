        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3><i class="fa fa-cart-plus">　</i><b><?php echo $name?></b>----库存列表</h3>
                </div>
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12 p-m">
                            <form action="<?php echo Url::to(['warehouse/inventory'])?>" method="get">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if (is_array($list)): foreach ($list as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <b>
                                            <a class="btn btn-success btn-rounded btn-outline btn-xs" href="<?php echo Url::to(['warehouse/spec','id'=>$v['id']])?>"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;查看入库规格</a>
                                        </b>
                                    </td>
                                    ...
                                    <td align="center">
                                        ...
                                        <?php else:?>
                                            ...
                                            <a href="<?php echo Url::to(['warehouse/recommended','id'=>$v['id'],'s_id'=>$id,'is_recom'=>0,'name'=>$name,'status'=>1])?>" type="button"   class="btn btn-sm btn-success btn-outline btn-xs btn-rounded "><i class="glyphicon glyphicon-resize-vertical"></i>取消推荐</a>

                                        <?php endif;?>

                                        <?php if($v["status"] == 0):?>
                                            <a class="btn btn-primary btn-rounded btn-outline btn-xs" href="<?php echo Url::to(['warehouse/entrepot-status','Entrepot_id'=>$v['id'],'status'=>1,'id'=>$id,'name'=>$name])?>"><i class="fa fa-check"></i>&nbsp;启用</a>
                                        <?php else:?>
                                            <a class="btn btn-danger btn-rounded btn-outline btn-xs" href="<?php echo Url::to(['warehouse/entrepot-status','Entrepot_id'=>$v['id'],'status'=>0,'id'=>$id,'name'=>$name])?>"><i class="glyphicon glyphicon-remove"></i>&nbsp;禁用</a>
                                        <?php endif;?>
...
<div class="modal inmodal" id="add_per" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <form class="myform" action="<?php echo Url::to(['warehouse/recommended'])?>" method="get">
