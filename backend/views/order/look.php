                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <?php if($value['status'] == 1):?>
                                            <a href="<?php echo Url::to(['merchant-user/status-content','id'=>$value['id'],'status'=>0])?>" class="btn btn-xs btn-danger btn-rounded"><i class="fa fa-heart"></i> 隐藏</a>
                                        <?php else: ?>
                                            <a href="<?php echo Url::to(['merchant-user/status-content','id'=>$value['id'],'status'=>1])?>" class="btn btn-xs btn-primary btn-rounded"><i class="fa fa-pencil"></i> 显示</a>
                                        <?php endif;?>
                                    </td>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php foreach ($listsPay as $key => $value): ?>
                                <tr>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php foreach ($listsRecord as $key => $value): ?>
                                <tr>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php foreach ($listsDetailed as $key => $value): ?>
                                <tr>
