            ...
            <div class="panel-heading">
                ...
                <div class="panel-options">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active">
                            <a data-toggle="tab" href="<?php echo Url::to(['order/index','order_status'=>'00'])?>" aria-expanded="true">
                                <img class="setting_logo" src="/img/svg/wechat.png"/>&nbsp;&nbsp;&nbsp;全部
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab" onclick='location.href="<?php echo Url::to(['order/index','order_status'=>'01'])?>"' href="" aria-expanded="false">
                                <img class="setting_logo" src="/img/svg/alipay.png"/>&nbsp;&nbsp;&nbsp;待发货
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab" onclick='location.href="<?php echo Url::to(['order/index','order_status'=>1])?>"' href="" aria-expanded="false">
                                <img class="setting_logo" src="/img/svg/sms_yzx.png"/>&nbsp;&nbsp;&nbsp;待收货
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab"  onclick='location.href="<?php echo Url::to(['order/index','order_status'=>2])?>"'  href="" aria-expanded="false">
                                <img class="setting_logo" src="/img/svg/sms_dpj.png"/>&nbsp;&nbsp;&nbsp;待评价
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab"  onclick='location.href="<?php echo Url::to(['order/index','order_status'=>3])?>"' href="">
                                <img class="setting_logo" src="/img/svg/sms_ok.png"/>&nbsp;&nbsp;&nbsp;已完成
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab"  onclick='location.href="<?php echo Url::to(['order/index','order_status'=>4])?>"' href="" >
                                            ...
                                            <div class="col-sm-5 p-m">
                                                <form method="get" action="/order/index">
                                                    <div class="input-group list-group col-sm-6">
                                                        <input type="text" name="keyword" placeholder="请输订单号检索" class="input-sm form-control">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php foreach ($lists as $key => $value): ?>
                                                    <tr style="height: 60px">
                                                        ...
                                                        <td align="center">
                                                            <button type="button"  class="btn btn-default del btn-xs btn-outline btn-rounded">
                                                                <?php echo $value->entrepot->entrepot_name; ?>
                                                            </button>

                                                        </td>
                                                        <td align="center">
                                                            <?php echo \backend\models\Order::return_status($value->order_status) ?>
                                                        </td>
                                                        <td align="center">
                                                            <?php echo $value->create_time; ?>
                                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <b><i class='glyphicon glyphicon-dashboard'></i>&nbsp;<?php \backend\models\order::return_time($value['create_time'])?></b>
                                                        </td>

                                                        <?php if($order_status == 4):?>
                                                            <td align="center"> <u><?php echo $value->cause; ?></u></td>
                                                        <?php endif;?>

                                                        <td align="center">
                                                            <?php if($value['order_status'] != 0):?>
                                                                <a href="  <?php echo Url::to(['order/look', 'id' => $value->id]) ?>">
                                                            ...
                                                            <?php if($value['order_status'] == 0):?>
                                                                <a href="  <?php echo Url::to(['order/show', 'id' => $value->id]) ?>">
