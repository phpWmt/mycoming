                ...
                <div class="ibox-content">
                    <div class="form-group" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <p class="help-block help-block-error"> <a href="<?php echo Url::to(['user/search','keyword'=>$order['user']['nickname']])?>" title="点击查看"><?php echo $order['user']['nickname']?></a></p>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <p class="help-block help-block-error"><a href="<?php echo Url::to(['warehouse/index','keyword'=>$order['entrepot']['entrepot_name']])?>" title="点击查看"><?php echo $order['entrepot']['entrepot_name']?></a></p>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                ...
                <div class="ibox-content">
                        <div class="form-group" style="font-size: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <p class="help-block help-block-error">
                                        <a class="btn btn-info btn-rounded btn-outline btn-sm" href="<?php echo Url::to(['order/look', 'id' => $id]) ?>"><i class="glyphicon glyphicon-eye-open"></i>&nbsp;&nbsp;查看发货记录</a>
                                    </p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <!--  购买用户-->
                        <input name="user_id" type="hidden" value="<?php echo $order['user_id']?>">
