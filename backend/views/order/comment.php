            ...
            <div class="panel-heading">
                ...
                <div class="panel-options">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active">
                            <a data-toggle="tab" onclick='location.href="<?php echo Url::to(['order/comment','grade'=>3])?>"' href="" aria-expanded="true">
                                <img class="setting_logo" style="height: inherit" src="/img/svg/good.png"/>&nbsp;&nbsp;&nbsp;好评
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab" onclick='location.href="<?php echo Url::to(['order/comment','grade'=>2])?>"' href="" aria-expanded="false">
                                <img class="setting_logo" style="height: inherit" src="/img/svg/middle.png"/>&nbsp;&nbsp;&nbsp;中评
                            </a>
                        </li>

                        <li class="">
                            <a data-toggle="tab" onclick='location.href="<?php echo Url::to(['order/comment','grade'=>1])?>"' href="" aria-expanded="false">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php if(!empty($listsComment)):foreach ($listsComment as $key => $value): ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="<?php echo Url::to(['user/search','keyword'=>$value['user']['nickname']])?>" title="点击查看"><?php echo $value['user']['nickname']; ?></a>
                                                        </td>

                                                        <td align="center">
                                                            <a href="<?php echo Url::to(['warehouse/index','keyword'=>$value['entrepot']['entrepot_name']])?>" title="点击查看"><?php echo $value['entrepot']['entrepot_name']; ?></a>
                                                        </td>

                                                        <td align="center">
                                                            <a href="<?php echo Url::to(['goods/list','keyword'=>$value['goods']['title']])?>" title="点击查看"><?php echo $value['goods']['title']; ?></a>
                                                        </td>
                                                        ...
                                                        <td align="center">
                                                            <?php if($value['status'] == 1):?>
                                                                <a href="<?php echo Url::to(['user/status-content','id'=>$value['id'],'status'=>0])?>" class="btn btn-xs btn-danger btn-rounded btn-outline"><i class="glyphicon glyphicon-remove"></i> 隐藏</a>
                                                            <?php else: ?>
                                                                <a href="<?php echo Url::to(['user/status-content','id'=>$value['id'],'status'=>1])?>" class="btn btn-xs btn-primary btn-rounded btn-outline"><i class="glyphicon glyphicon-ok"></i> 显示</a>
                                                            <?php endif;?>

                                                            <button data-id="<?php echo $value['id']; ?>" href="javascript:void (0)" type="button" class="btn btn-danger btn-outline btn-xs del btn-rounded "><i class="fa fa-trash-o"></i>&nbsp;删除</button>
