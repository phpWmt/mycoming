                ...
                <div class="ibox-content">
                    <form class="myform form-horizontal" action="<?php echo Url::to(['article/create'])?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="" name="title" placeholder="请填写文章标题！" required>
                            </div>
                        </div>
...
<!--                            <div class="col-sm-9">-->
<!--                                <select class="form-control in-block" name="cate_id" datatype="*" nullmsg="请选择所属分类！">-->
