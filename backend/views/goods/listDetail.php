                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if (is_array($list)): foreach ($list as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo Url::to(['goods/look-spec','spec'=> $v['spec']])?>" class="btn btn-info btn-outline btn-xs btn-rounded goods">查看规格</a>
                                    </td>

                                    <td align="center"><a href="<?php echo Url::to(['warehouse/index','keyword'=>$v['entrepot']["entrepot_name"]])?>"><?php echo($v['entrepot']["entrepot_name"] ? $v['entrepot']["entrepot_name"] : "<button class='btn btn-warning btn-rounded btn-outline btn-xs'>总仓库</button>" ); ?></a></td>
