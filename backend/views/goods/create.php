                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="myform form-horizontal">
                        ...
                        <div class="form-group field-goods-cate_id required">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="cate_id" required="true" datatype="*" nullmsg="不可为空">
                        ...
                        <div class="form-group field-goods-cate_id required">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="brand_id" required="true" datatype="*" nullmsg="不可为空">
...
<!---->
<!--                        <div class="form-group">-->
<!--                            <label class="col-sm-2 control-label" for="goods-num">是否热销:</label>-->
<!--                            <div class="col-sm-8">-->
<!--                                <label class="checkbox-inline i-checks">-->
<!--                                    <input type="radio" name="is_hot" checked value="1">关闭-->
<!--                                </label>-->
<!--                                <label class="checkbox-inline i-checks">-->
<!--                                    <input type="radio" name="is_hot" value="2">开启-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="hr-line-dashed"></div>-->
...
<!--                            <label class="col-sm-2 control-label" for="goods-num">是否促销:</label>-->
<!--                            <div class="col-sm-8">-->
<!--                                <label class="checkbox-inline i-checks">-->
<!--                                    <input type="radio" name="is_sale" checked value="1">关闭-->
<!--                                </label>-->
<!--                                <label class="checkbox-inline i-checks">-->
<!--                                    <input type="radio" name="is_sale" value="2">开启-->
<!--                                </label>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="hr-line-dashed"></div>-->
<!--                        <div class="form-group" id="sale_price">-->
<!--                            <label class="col-sm-2 control-label" for="goods-price">促销单价:</label>-->
<!--                            <div class="col-sm-8">-->
<!--                                <input type="number" class="form-control" placeholder="不参与促销,价格可不用填写！" name="sale_price" min="0" step="number">-->
<!--                            </div>-->
<!--                        </div>-->
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
