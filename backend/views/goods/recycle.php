                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12 p-m">
                            ...
                            <button id="delete_all" class="btn btn-sm btn-outline btn-danger m-l del_all" type="button"><i class="glyphicon glyphicon-trash"></i>&nbsp;&nbsp;批量删除</button>
                        </div>
                    </div>
