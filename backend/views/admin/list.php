                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-6 p-m">
                            ...
                            <a href="<?php echo Url::to(['admin/index']) ?>"><button type="button" class="btn btn-sm btn-primary btn-outline"><i class="fa fa-user-plus"></i>添加管理员</button></a>
                            ...
                            <?php if (is_array($model)): foreach ($model as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a class="btn btn-info btn-rounded btn-outline btn-xs" href="buttons.html#">    <?php echo($v["type"]==1 ? "管理员" : "仓库管理员"); ?></a>
                                    </td>
                                    <td align="center">
                                        <a class="btn btn-danger btn-rounded btn-outline btn-xs" href="buttons.html#">  <?php echo($v["entrepot"]['entrepot_name'] ? $v["entrepot"]['entrepot_name'] : "总后台"); ?></a>
                                    </td>

                                    <td align="center"><?php echo($v["create_time"]); ?></td>
                                    <td align="center"><?php echo($v["last_time"]); ?></td>
                                    <td align="center">
                                        <a class="btn btn-danger btn-rounded btn-outline btn-xs" href="buttons.html#"><i class="glyphicon glyphicon-arrow-up"></i>&nbsp;<?php echo($v["login_num"]); ?></a>
                                    </td>
                                    <td align="center">
                                        ...
                                        <a href="<?php echo Url::to(['admin/assign','id'=>$v['id'],'status'=>$v['type']])?>">
