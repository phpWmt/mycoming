...
//        'yii\bootstrap\BootstrapAsset',
    ...
    public static function addJs($view, $file_path) {
        $view->registerJsFile($file_path, [AppAsset::className(), "depends" => "backend\assets\AppAsset"]);
    }
    ...
    public static function addCss($view, $file_path) {
        $view->registerCssFile($file_path, [AppAsset::className(), "depends" => "backend\assets\AppAsset"]);
    }
}
