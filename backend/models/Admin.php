...
class Admin extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'create' => ['username', 'password', 'password2', 'name', 'phone','entrepot','type'],
    ...
    {
        return [
            ['username','unique','targetClass' =>'\backend\models\Admin','message'=>'该账号已被占用','on'=>'create'],
            ['phone', 'unique', 'targetClass' =>'\backend\models\Admin','message' => '该手机号已注册','on'=>'create'],
            ['phone','match','pattern'=>'/^[1][3758][0-9]{9}$/','message'=>'请输入正确的手机号','on'=>['create','update']],
