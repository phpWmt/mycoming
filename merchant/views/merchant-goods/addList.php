    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <p>
                    <a href="<?php echo Url::to(['merchant-goods/remove','id'=>$id])?>" style="width: 20%;" type="button" class="btn btn-block btn-primary">全部删除</a>
                </p>
...
$(".myform").Validform({
    ...
    callback: function (submitForm) {
        $(submitForm).ajaxSubmit({
            url: "/merchant/merchant-goods/add-list",
            type: "post",
            dataType: "json",
