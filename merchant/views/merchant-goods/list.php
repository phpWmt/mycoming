                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12 p-m">
                            ...
                            <a href="<?php echo Url::to(['merchant-goods/create']) ?>"><button type="button" class="btn btn-sm btn-primary btn-outline"><i class="glyphicon glyphicon-calendar"></i>&nbsp;&nbsp;添加商品</button></a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if (is_array($list)): foreach ($list as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo Url::to(['merchant-goods/godown','id'=>$v['id']]) ?>">
