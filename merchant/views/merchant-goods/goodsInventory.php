                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if (is_array($list)): foreach ($list as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a class="btn btn-info btn-rounded btn-outline btn-xs" href="<?php echo Url::to(['warehouse/index','keyword'=>$v['entrepot']["entrepot_name"]])?>"><i class="glyphicon glyphicon-home"></i>&nbsp;<?php echo($v["entrepot"]['entrepot_name']); ?></a>
                                    </td>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?php echo Url::to(['merchant-goods/spec-increase','Add_id'=>$v['id'],'return'=>'status'])?>">
