                        ...
                        <div class="form-group">
                            ...
                            <div id="permissions" class="col-sm-10">
                                ...
                                <div class="col-md-2" style="width:200px;">
                                    <input  type="number" id="<?php echo $value['id']?>" name="total_num[]" maxlength="7" style="color:red"  value="<?php echo intval($value['num'])?>" onkeyup="value=value.replace(/[^0-9]/g,'')" required placeholder="入库数量"  class="form-control">
                                </div>
...
$(".myform").Validform({
    ...
    callback: function (submitForm) {
        $(submitForm).ajaxSubmit({
            url: "/merchant/merchant-goods/godown",
            type: "post",
            dataType: "json",
