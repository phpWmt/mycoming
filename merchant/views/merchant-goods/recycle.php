        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3><i class="fa fa-cart-plus">　</i>回收站列表</h3>
                </div>
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12 p-m">
                            ...
                            <button id="delete_all" class="btn btn-sm btn-outline btn-danger m-l del_all btn-rounded" type="button"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;批量删除</button>
                        </div>
                    </div>
...
<!--                                <th class="text-center"><b>商品出入库</th>-->
                            ...
                            <?php if (is_array($list)): foreach ($list as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a class="btn btn-danger btn-rounded btn-outline btn-xs" href="#"><i class="glyphicon glyphicon-th-list"></i> &nbsp;<?php echo($v["entrepot"]['entrepot_name'] ? $v["entrepot"]['entrepot_name'] : "总仓库" ); ?></a>
                                    </td>

                                    <td align="center"><?php echo($v["list_price"]); ?></td>
                                    <td align="center"><img class="goods_img" src="<?php echo ($v["cover"]); ?>"></td>
                                    ...
                                    <td align="center">
                                        ...
                                        <button data-id="<?php echo $v['id'] ?>" href="javascript:void (0)" type="button" class="btn btn-info btn-outline btn-xs del btn-rounded "><i class="fa fa-trash-o"></i>&nbsp;还原</button>
...
$js=<<<JS
        ...
        $('.all-checks').on('ifUnchecked', function (event) {
            ...
            var d = dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "/merchant/merchant-goods/delete",
                        type: "post",
                        dataType: "json",
                        data:{
                            'id':id,
        ...
        $(".del").click(function () {
            ...
            var d = dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "/merchant/merchant-goods/update-restore",
                        type: "post",
                        dataType: "json",
                        data:{
                            'id':id,
